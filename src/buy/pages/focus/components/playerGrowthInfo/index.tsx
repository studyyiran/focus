...
export const PlayerGrowthInfo: React.FC<IRenderPlayerGrowthInfo> = ({
  ...
  // 不能用组件来定义。会导致里面的内容全部rerender
  const PokemonInfo = (level?: any, hide?: any) => {
    if (config[level]) {
        ...
        <div className="pokemon-info">
          ...
          <div className="info">
            ...
            <div>
              ...
              <Progress
                current={userSunny && userSunny.sunnyCount}
                max={1000}
              />
              <UserSunny />
            </div>
  ...
  return (
    <section className={"player-growth-info"}>
      <div className="pokemon-container">
        {PokemonInfo(currentLevelIndex)}
        {/*<span>=></span>*/}
